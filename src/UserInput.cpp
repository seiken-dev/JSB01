...
constexpr uint16_t buttonThreshold = 5;
constexpr uint16_t longThreshold = 500;
...
void checkPin()
{
  ...
  static int cBtn1, cBtn2, pBtn1=HIGH, pBtn2=HIGH; // 呼ばれたときと直前のピン状態
...
#elif ARDUINO_XIAO_ESP32C3
hw_timer_t * timer = NULL;
void IRAM_ATTR cbCheckPIn() {
  static unsigned long btn1Expire = 0, btn2Expire=0;  
  static int cBtn1, cBtn2, pBtn1=HIGH, pBtn2=HIGH; // 呼ばれたときと直前のピン状態
  cBtn1 = digitalRead(pin_button1);
  cBtn2 = digitalRead(pin_button2);
